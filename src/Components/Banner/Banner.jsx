                ...
                <Slider {...settings}>
                    {
                        products?.map((product) => (
                            <div key={product?.id} className="banner_slide_item">
                                ...
                                {/* banner text  */}
                                <div className="ml-10 mt-20 banner_text">
                                ...
                                {/* banner image  */}
                                <div className="banner_image mt-[-10rem] w-full h-full flex items-center justify-end">
                                    <img className="mr-30" src={product?.image} alt={product?.title} />
                                </div>
